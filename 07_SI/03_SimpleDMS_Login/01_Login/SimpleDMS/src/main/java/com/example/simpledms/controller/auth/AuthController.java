...
//                에러 처리
    ...
    public ResponseEntity<Object> findAllByUsernameContaining(@RequestParam String username, Pageable pageable) {
        try {
            Page<User> page = userService.findAllByUsernameContaining(username, pageable);
